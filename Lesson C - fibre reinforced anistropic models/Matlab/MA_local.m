function [cstress, kirchIso, kirchAniso, kirch] = MA_local(F, props)
%MA_LOCAL Calculate stress defined by MA hyperelastic constitutive model
%   MA_LOCAL(F, props) returns the stress for a given deformation gradient
%   F defined in a local coordinate system, and set of material properties 
%   defined in PROPS.
